...
# set runner ENV
ENV MIX_ENV="prod"
ENV SECRET_KEY_BASE="mJZqTY5pUwg2m4MuCFb3rLUZea6Ez9ceSswraxzGjCDfrNxkLdY2WOwImBFnvEx6"


# Only copy the final release from the build stage
COPY --from=builder --chown=nobody:root /app/_build/${MIX_ENV}/rel/standard ./
